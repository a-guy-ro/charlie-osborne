...
const modalHeight = isCv ? ((windowWidth*modalWidth)/windowHeight) * (1.1*artist_statement.gatsbyImageData.height/artist_statement.gatsbyImageData.width) + 0.01:
                ...
                <div className = "modalPlayerImage">
                    ...
                    <div className = "textBase">
                        <p className = "textBody" numberOfLines = {textLines}>
                            ...
                            <br/><br/>
                            {statementText_2}
                            <p className = "textEmail">{emailText}</p>
                        </p>
                        <span></span>
